h1. Opinoid. News syndication, democratized.

p. A web application intended to syndicate news from a number of known RSS/Atom sources and provide visitors with a sorted list (like Reddit) based on user's votes and comments.
...
p. An alpha version is available at http://alpha.opinoid.com (rather slow vps), please report issues and ideas.